...
goog.provide('unisubs.subtitle.ConfirmRejectiondDialog');

/**
 * @constructor
 * @private
 */
unisubs.subtitle.ConfirmRejectiondDialog = function( callback) {
    goog.ui.Dialog.call(this, 'unisubs-modal-completed', true);
    this.setButtonSet(null);
    this.setDisposeOnHide(true);
    this.callback_ = callback;
};
goog.inherits(unisubs.subtitle.ConfirmRejectiondDialog, goog.ui.Dialog);

unisubs.subtitle.ConfirmRejectiondDialog.prototype.createDom = function() {
    unisubs.subtitle.ConfirmRejectiondDialog.superClass_.createDom.call(this);
...
unisubs.subtitle.ConfirmRejectiondDialog.prototype.enterDocument = function() {
    unisubs.subtitle.ConfirmRejectiondDialog.superClass_.enterDocument.call(this);
    var that = this;
...
unisubs.subtitle.ConfirmRejectiondDialog.prototype.cancelClicked_ = function(e) {
    e.preventDefault();
    this.hideDialog();
}
unisubs.subtitle.ConfirmRejectiondDialog.prototype.okClicked_ = function(e) {
    e.preventDefault();
...
unisubs.subtitle.ConfirmRejectiondDialog.prototype.hideDialog = function(e){
    var that = this;
 ...
 */
unisubs.subtitle.ConfirmRejectiondDialog.show = function( callback) {
    var dialog = new unisubs.subtitle.ConfirmRejectiondDialog(callback);
